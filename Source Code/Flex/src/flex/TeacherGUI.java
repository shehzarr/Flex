...
public class TeacherGUI extends javax.swing.JFrame {
    ...
    public TeacherGUI(String title,String id) throws HeadlessException {
        initComponents();
        setSize(900, 500);
        setLocationRelativeTo(null);
        this.teacherName=title;
    ...
    private void addmarksActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addmarksActionPerformed
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GoToMarks(TeacherGUI.teacherId,"Teacher").setVisible(true);
            }
        });
    ...
    private void changepasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_changepasswordActionPerformed
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new changePassword("teacher",idField.getText()).setVisible(true);
            }
        });
