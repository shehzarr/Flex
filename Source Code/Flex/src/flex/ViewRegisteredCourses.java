 ...
 * @author Shehzar
 */
public class ViewRegisteredCourses extends javax.swing.JFrame {
    ...
    public ViewRegisteredCourses() {
        initComponents();
//        System.out.println(getSize().toString());

    }

    public ViewRegisteredCourses(String _id, String name, String batch) throws HeadlessException {

//        setTitle("Registered Courses");
//        id = _id;
        initComponents();
        setSize(900, 500);
...
//        add(panel);
//        initFrame();
        back = createbutton("Back", 10, 25);
        createLabel("", 10, 25, true);
        createLabel("", 10, 25, true);
        //initComponents();
        int row = 3;
        createLabel("Student ID: ", 10, row * 25, true);
        createLabel(_id, 100, row * 25, false);
        createLabel("", 10, 25, true);
        row++;
        row++;
        dbconnectivity db = new dbconnectivity();
        List<Course> c = new ArrayList<Course>();
        c = db.viewregisteredcourses(_id);

        array = new JLabel[(c.size() * 3) + 3];
        int i = 0;
        for (int j = 0; j < ((c.size() * 3) + 3); j++) {
            if (j == 0) {
                array[j] = createLabel("Course", 10, row * 25, true);
                j++;
                array[j] = createLabel("Section", 188, row * 25, true);
                j++;
                array[j] = createLabel("Grade", 238, row * 25, true);
                row++;
                continue;
            }
            array[j] = createLabel(c.get(i).courseName, 10, row * 25, false);
            j++;
            array[j] = createLabel(c.get(i).section, 200, row * 25, false);
            j++;
            array[j] = createLabel(c.get(i).grade, 250, row * 25, false);
            i++;
            row++;
        }
        ...
        viewregisteredcoursesgui.add(scroll);
//        add(scroll);
//        scroll.add(northOnlyPanel,JScrollPane.VERTICAL_SCROLLBAR_ALWAYS, JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
    ...
    private void initComponents() {
        ...
        viewregisteredcoursesgui = new javax.swing.JPanel();
        ...
        viewregisteredcoursesgui.setLayout(new java.awt.BorderLayout());
        ...
        bgLayout.setHorizontalGroup(
            ...
            .addGroup(bgLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(viewregisteredcoursesgui, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );
        bgLayout.setVerticalGroup(
            ...
            .addGroup(bgLayout.createSequentialGroup()
                .addGap(70, 70, 70)
                .addComponent(viewregisteredcoursesgui, javax.swing.GroupLayout.PREFERRED_SIZE, 404, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private JComboBox createCombo(String[] text, int x, int y) {
        ...
        viewregisteredcoursesgui.add(combo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewRegisteredCourses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewRegisteredCourses().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JPanel viewregisteredcoursesgui;
