 ...
 * @author Shehzar
 */
public class ViewAttendanceGUI extends javax.swing.JFrame {
    ...
    public ViewAttendanceGUI(String id, String course_name, String request) {
        initComponents();
        setSize(900, 500);
        ...
        obj.getAttendance(jLabel2.getText(), course_name, a);

        for (Attendance obj1 : a) {
            data[0] = obj1.lectureNo;
            data[1] = obj1.currentDate;
    ...
    private void initComponents() {
        ...
        viewattendancegui = new javax.swing.JPanel();
        ...
        viewattendancegui.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Lecture No", "Date", "Duration (hrs)", "Status"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        javax.swing.GroupLayout viewattendanceguiLayout = new javax.swing.GroupLayout(viewattendancegui);
        viewattendancegui.setLayout(viewattendanceguiLayout);
        viewattendanceguiLayout.setHorizontalGroup(
            viewattendanceguiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(viewattendanceguiLayout.createSequentialGroup()
                .addGroup(viewattendanceguiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(viewattendanceguiLayout.createSequentialGroup()
                        .addGap(95, 95, 95)
                        .addComponent(jButton1))
                    .addGroup(viewattendanceguiLayout.createSequentialGroup()
                        .addGap(236, 236, 236)
                        .addGroup(viewattendanceguiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        viewattendanceguiLayout.setVerticalGroup(
            viewattendanceguiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, viewattendanceguiLayout.createSequentialGroup()
                .addGap(22, 22, 22)
                .addComponent(jButton1)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 63, Short.MAX_VALUE)
                .addGroup(viewattendanceguiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(jLabel2))
        ...
        bgLayout.setHorizontalGroup(
            ...
            .addGroup(bgLayout.createSequentialGroup()
                ...
                .addGap(28, 28, 28)
                .addComponent(viewattendancegui, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAttendanceGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAttendanceGUI().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JPanel viewattendancegui;
