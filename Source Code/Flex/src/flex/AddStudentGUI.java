...
//        scrollpanel.getViewport().setPreferredSize(new Dimension(160, 200));
        ...
        data.add(entries[i]);
        i++;
        data.add(createLabel("First Name:", 0, 0, true));
        entries[i] = createTextField(0, 0);
        data.add(entries[i]);
        i++;
        data.add(createLabel("Last Name:", 0, 0, true));
        entries[i] = createTextField(0, 0);
        data.add(entries[i]);
        i++;
        data.add(createLabel("Password:", 0, 0, true));
        entries[i] = createTextField(0, 0);
        data.add(entries[i]);
        i++;
        data.add(createLabel("Address:", 0, 0, true));
        entries[i] = createTextField(0, 0);
        data.add(entries[i]);
        i++;
        data.add(createLabel("Phone Number:", 0, 0, true));
        entries[i] = createTextField(0, 0);
        data.add(entries[i]);
        i++;
        data.add(createLabel("Father Name:", 0, 0, true));
        entries[i] = createTextField(0, 0);
        data.add(entries[i]);
        i++;
        data.add(createLabel("Date of Birth:", 0, 0, true));
        entries[i] = createTextField(0, 0);
        data.add(entries[i]);
        i++;
        data.add(createLabel("Batch:", 0, 0, true));
        entries[i] = createTextField(0, 0);
        data.add(entries[i]);
        i++;
        data.add(createLabel("Credit Hours Attempted:", 0, 0, true));
        entries[i] = createTextField(0, 0);
        data.add(entries[i]);
        i++;
        data.add(createLabel("Credit Hours Obtained:", 0, 0, true));
        entries[i] = createTextField(0, 0);
        data.add(entries[i]);
        i++;
        data.add(createLabel("Current Semester:", 0, 0, true));
        entries[i] = createTextField(0, 0);
        data.add(entries[i]);
        i++;
        ...
        addstudentgui.add(scroll,BorderLayout.CENTER);
...
//        panel.add(but);
    ...
    private void initComponents() {
        ...
        addstudentgui = new javax.swing.JPanel();
        ...
        addstudentgui.setLayout(new java.awt.BorderLayout());
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(addstudentgui, javax.swing.GroupLayout.DEFAULT_SIZE, 368, Short.MAX_VALUE)
                .addGap(14, 14, 14))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(78, 78, 78)
                .addComponent(addstudentgui, javax.swing.GroupLayout.PREFERRED_SIZE, 325, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private javax.swing.JPanel addstudentgui;
